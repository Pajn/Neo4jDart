...
class Neo4j {
  ...
  Neo4j(
      {this.host: 'http://127.0.0.1:7474', String username, String password}) {
    if (username != null) {
  ...
  Future<Map<String, List>> cypher(String query,
          {Map<String, dynamic> parameters, List<String> resultDataContents}) =>
      new Transaction(this).cypher(query,
  ...
  Transaction startCypherTransaction() => new Transaction(this);
}
